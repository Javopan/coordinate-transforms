...
class Ui_MatrixCalculator(object):
    def setupUi(self, MatrixCalculator):
        ...
        MatrixCalculator.resize(685, 741)
        ...
        self.chk_alllos = QtWidgets.QCheckBox(self.frm_los)
        self.chk_alllos.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.chk_alllos.setFont(font)
        self.chk_alllos.setStyleSheet("color: rgb(50, 175, 74);")
        self.chk_alllos.setObjectName("chk_alllos")
        self.verticalLayout.addWidget(self.chk_alllos)
    ...
    def retranslateUi(self, MatrixCalculator):
        ...
        self.chk_alllos.setToolTip(_translate("MatrixCalculator", "If enable the output will have all the links, with and without LoS. "))
        self.chk_alllos.setText(_translate("MatrixCalculator", "All Links"))
